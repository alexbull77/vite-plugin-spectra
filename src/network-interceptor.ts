...
export const setupNetworkInterceptor = ({
    ...
    window.fetch = async (...args) => {
        ...
        const isSpectraRequest = getHeaderValue(config?.headers, 'x-spectra-microfrontend') === name
...
const getHeaderValue = (headers: HeadersInit | undefined, headerName: string): string | null => {
